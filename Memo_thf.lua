...
function job_setup()
	...
	send_command('alias ohshit input /equip neck "Loricate torque +1"; input /equip ring1 "Vocane ring"; input /equip back "Moonbeam Cape"; input /equip ring2 "Defending ring";')
...
function init_gear_sets()
	...
	sets.idle.Refresh = {ammo="Staunch tathlum",
        ...
        back="Solemnity cape",waist="Flume belt +1",legs="Rawhide trousers",feet="Jute boots +1"}
	...
	sets.engaged.TH = {ammo="Yamarang",
        ...
        back=gear.ToutatisCape_STP,waist="Windbuffet belt +1",legs="Samnuha tights",feet="Skulker's poulaines"}
	...
	sets.engaged.DW = {ammo="Yamarang",
        ...
        back=gear.ToutatisCape_STP,waist="Reiki yotai",legs="Samnuha tights",feet=gear.herculeanBoots_TA}
