...
send_command('alias ohshit input /equip body "Ayanmo corazza +2"; input /equip head "Ayanmo zucchetto +1"; input /equip neck "Twilight torque"; input /equip ring1 "Vocane ring"; input /equip legs "Ayanmo cosciales +2"; input /equip ring2 "Defending ring";')
...
function init_gear_sets()
	...
	ear2="Etiolation Earring", hands="Leyline gloves", back="Swith cape",legs="Ayanmo cosciales +2", waist="Witful belt"}
  ...
  --  sets.precast.Waltz = {}
   ...
   -- gear.default.weaponskill_neck = "Asperity Necklace"
    ...
    sets.precast.WS['Chant du Cygne'] = {ammo="Jukukik feather",
        head="Adhemar bonnet",neck="Fotia gorget",ear1="Moonshade earring",ear2="Brutal earring", --Replace moonshade with some sort of DEX or multiattack.
        body="Ayanmo corazza +2",hands="Adhemar wristbands",ring1="Ilabrat Ring",ring2="Begrudging ring",
        back=gear.Rosmerta_CRIT,waist="Fotia Belt",legs="Samnuha tights",feet=gear.herculeanBoots_TA}
    
	sets.precast.WS['Requiescat'] = {ammo="Amar Cluster",
        head=gear.herculeanHelm_TA,neck="Fotia gorget",ear1="Domin. earring +1",ear2="Brutal Earring",
        body=gear.herculeanVest_TA,hands="Adhemar wristbands",ring1="Rufescent ring",ring2="Epona's Ring",
	...
	sets.precast.WS['Savage Blade'] = {ammo="Floestone",
        head=gear.herculeanHelm_WSD,neck="Fotia gorget",ear1="Moonshade earring",ear2="Ishvara Earring",
        body="Assimilator's jubbah +3",hands="Jhakri cuffs +2",ring1="Rufescent ring",ring2="Ifrit ring",
        back=gear.Rosmerta_WSD,waist="Metalsinger Belt",legs="Samnuha tights",feet=gear.herculeanBoots_RAWSD}

	sets.precast.WS['Black Halo'] = {ammo="Floestone",
        head=gear.herculeanHelm_TA,neck="Caro necklace",ear1="Moonshade earring",ear2="Ishvara Earring",
        body="Assimilator's jubbah +3",hands="Jhakri cuffs +2",ring1="Rufescent ring",ring2="Ifrit ring +1",
        back=gear.rosmertasCape_STP,waist="Metalsinger Belt",legs="Samnuha tights",feet="Jhakri pigaches +2"}
	...
	sets.midcast['Blue Magic'].Physical = {ammo="Floestone",
		head="Jhakri coronal +2",neck="Sanctity necklace",ear1="Domin. Earring +1",ear2="Vulcan's pearl",
		body="Jhakri robe +2",hands="Jhakri cuffs +2",ring1="Shukuyu Ring",ring2="Rajas Ring",
		back="Laic mantle",waist="Grunfeld rope",legs=gear.herculeanTrousers_Crit,feet="Jhakri pigaches +2"}

	sets.midcast['Blue Magic'].PhysicalAcc = {ammo="Amar Cluster",
		head="Jhakri coronal +2",neck="Sanctity necklace",ear1="Domin. Earring +1",ear2="Vulcan's pearl",
		body="Jhakri robe +2",hands="Jhakri cuffs +2",ring1="Ilabrat Ring",ring2="Rajas Ring",
		back="Laic mantle",waist="Grunfeld rope",legs=gear.herculeanTrousers_Crit,feet="Jhakri pigaches +2"}
	...
	sets.midcast['Blue Magic'].Magical =  { 
		ammo="Pemphredo tathlum", head="Jhakri coronal +1", neck="Baetyl pendant", ear1="Moldavite earring",ear2="Hecate's earring",
	...
	sets.midcast['Blue Magic'].Healing = {
		body="Assimilator's jubbah +3",neck="Phalaina locket", back="Cornflower cape",hands="Mavi bazubands +2", legs="Hashishin tayt"}
    ...
    sets.idle = {ammo="Staunch tathlum",
        head="Rawhide mask",neck="Twilight torque",ear1="Genmei earring",ear2="Etiolation earring",
        body="Vrikodara jupon",hands=gear.herculeanGloves_Refresh,ring1="Vocane Ring",ring2="Defending Ring",
	...
	sets.engaged.STP = {ammo="Ginsen",
        head="Adhemar bonnet",neck="Clotharius torque",ear1="Steelflash earring",ear2="Bladeborn earring",	
        body="Ayanmo corazza +2",hands="Adhemar wristbands",ring1="Petrov ring",ring2="Epona's ring",
        back=gear.Rosmerta_TP,waist="Windbuffet belt +1",legs="Samnuha tights",feet=gear.herculeanBoots_TA}

	sets.engaged.Acc = {ammo="Amar Cluster",
        head=gear.herculeanHelm_Crit,neck="Combatant's torque",ear1="Telos earring",ear2="Zennaroi earring",	
        body="Jhakri robe +1",hands="Adhemar wristbands",ring1="Cacoethic ring",ring2="Cacoethic ring +1",
        back=gear.rosmertasCape_STP,waist="Dynamic belt +1",legs="Jhakri slops +2",feet="Jhakri pigaches +2"}

	--sets.engaged.PDT = {ammo="Staunch tathlum",
     --   head="Sulevia's mask +2",neck="Diemer gorget",ear1="Upsurge Earring",ear2="Colossus's earring",
     --   body="Sulevia's platemail +2",hands="Sulevia's gauntlets +2",ring1="Eihwaz ring",ring2="Defending Ring",
     --   back="Rudianos's mantle",waist="Flume belt",legs="Sulevia's cuisses +2",feet="Souveran Schuhs +1"}
