...
function job_setup()
	...
	send_command('alias song1 input /ma "Advancing March" <me>; wait 6; input /ma "victory march" <me>; wait 6; input /ma "Army\'s paeon" <me>; wait 5; input /ma "Army\'s paeon II" <me>; wait 5; input /ma "valor minuet V" <me>; wait 6; input /ma "valor minuet IV" <me>;')
	send_command('alias song2 input /ma "Advancing March" <me>; wait 6; input /ma "victory march" <me>; wait 6; input /ma "valor minuet V" <me>; wait 6; input /ma "valor minuet IV" <me>;')
...
function init_gear_sets()
    ...
    sets.midcast["Magic Finale"] = {head="Inyanga tiara +2",neck="Moonbow Whistle",
        body="Fili Hongreline +1",hands="Fili Manchettes +1",
        back="Intarabus\'s cape",waist="luminary sash",legs="Inyanga Shalwar +2",feet="Brioso Slippers +1",range="gjallarhorn"}
    ...
    sets.midcast.SongDebuff = {
        ...
        body="Fili Hongreline +1",hands="Fili Manchettes +1",
        back="Intarabus\'s cape",waist="Pya'ekue belt",legs="Inyanga Shalwar +2",feet="Brioso Slippers +1"}
