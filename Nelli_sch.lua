...
-- Debuffs ALT	
	send_command('bind !1 input /ja "immanence" <me>')
	...
	send_command('bind !7 input /ma "Stone" <t>')
	send_command('bind !8 input /ma "Aero" <t>')
...
function init_gear_sets()
	...
	sets.precast.JA['Perpetuance'] = {hands="Arbatel bracers"}
