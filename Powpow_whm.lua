...
function init_gear_sets()
	...
	sets.precast.FC['Healing Magic'] = set_combine(sets.precast.FC, {back="Disperser's cape", feet="Cure clogs"})
    ...
    sets.idle = {main={name="Terra's Staff", priority=16},sub={name="Oneiros Grip", priority=15}, ammo="Homiliary",
        ...
        back="Solemnity cape",waist="Fucho-no-obi",legs="Carmine cuisses +1",feet="Crier's gaiters"}		
