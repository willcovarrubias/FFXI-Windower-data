...
function init_gear_sets()
    ...
    sets.precast.WS['Myrkr'] = {
		head="Pixie hairpin +1",neck="Sanctity necklace",ear1="Andoaa earring",ear2="Etiolation earring",
        body="Witching robe",hands="Telchine gloves",ring1="Rahab ring",ring2="Etana ring",
        back=gear.TaranusCape_FC,waist="Luminary sash",legs="Psycloth lappas",feet="Psycloth boots"}
	...
	sets.midcast['Elemental Magic'] = {ammo="Pemphredo tathlum",
        head="Archmage's petasos +3",neck="Baetyl pendant",ear1="Regal earring",ear2="Barkarole earring",
        body="Shamash robe",hands="Amalric gages +1",ring1="Shiva Ring +1",ring2="Shiva Ring +1",
        back=gear.TaranusCape_MAB,waist=gear.ElementalObi,legs="Archmage's tonban +3",feet="Archmage's sabots +3"}
	...
	sets.midcast['Elemental Magic'].MBMerit = set_combine(sets.midcast['Elemental Magic'], {head=gear.merlinicHood_MBB, neck="Mizukage-no-Kubikazari",body="Spaekona's coat +3", 
