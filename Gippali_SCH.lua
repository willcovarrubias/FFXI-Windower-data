...
function init_gear_sets()
    ...
    sets.midcast.Cure = {main="Tamaxchi",sub="Genbu's Shield",ammo="Incantor Stone",
        ...
        body="Heka's Kalasiris",hands="Bokwus Gloves",ring1="Prolix Ring",ring2="Ephedra Ring",
    ...
    sets.midcast['Elemental Magic'].Resistant = {main="Lehbrailg +2",sub="Mephitis Grip",ammo="Dosis Tathlum",
        ...
        back="Toro Cape",waist=gear.ElementalObi,legs="Hagondes Pants +1",feet="Bokwus Boots"}
    ...
    sets.midcast.Impact = {main="Lehbrailg +2",sub="Mephitis Grip",ammo="Dosis Tathlum",
        ...
        back="Toro Cape",waist="Demonry Sash",legs="Hagondes Pants +1",feet="Bokwus Boots"}
    ...
    sets.defense.PDT = {main=gear.Staff.PDT,sub="Achaq Grip",ammo="Incantor Stone",
        ...
        back="Umbra Cape",waist="Hierarch Belt",legs="Hagondes Pants +1",feet="Hagondes Sabots"}
    ...
    sets.engaged = {
        ...
        waist="Goading Belt",legs="Hagondes Pants +1",feet="Hagondes Sabots"}
