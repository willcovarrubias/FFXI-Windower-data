...
function job_setup()
	...
	send_command('alias cpring input /equip ring1 "Capacity Ring"; wait 7; input /item "Capacity Ring" <me>')
    send_command('alias trizek input /equip ring1 "Trizek Ring"; wait 7; input /item "Trizek Ring" <me>')
...
function user_setup()
	...
	state.OffenseMode:options('Att', 'Acc', 'TH', 'DW', 'Tank')
...
function init_gear_sets()
    ...
    sets.precast.FC = {
		head=gear.herculeanHelm_MAB,neck="Voltsurge torque",ear1="Etiolation Earring",ear2="Enchanter earring +1",
        body="Dread Jupon",hands="Leyline gloves",ring1="Rahab Ring",ring2="Prolix ring",
	...
	sets.precast.WS['Dancing Edge'] = {ammo="Jukukik feather",
	...
	sets.precast.WS['Mandalic Stab'] = {ammo="Jukukik feather",
        ...
        body=gear.herculeanVest_WSD,hands="Meghanada gloves +2",ring1="Regal ring",ring2="Ilabrat Ring",
	...
	sets.precast.WS['Rudra\'s Storm'] = {ammo="Seething bomblet",
        ...
        body=gear.herculeanVest_WSD,hands="Meghanada gloves +2",ring1="Regal ring",ring2="Ilabrat Ring",
        back=gear.ToutatisCape_WSD,waist="Grunfeld rope",legs=gear.herculeanTrousers_WSD,feet=gear.herculeanBoots_MAB}
    ...
    sets.idle = {ammo="Staunch tathlum",
		head="Meghanada visor +1",neck="Loricate torque +1",ear1="Infused earring",ear2="Odnowa earring +1",
    ...
    sets.engaged.Att = {ammo="Yamarang",
		head="Mummu bonnet +2",neck="Anu torque",ear1="Sherida earring",ear2="Brutal Earring",
        body="Adhemar jacket",hands=gear.herculeanGloves_QA,ring1="Epona's ring",ring2="Petrov Ring",
        back=gear.ToutatisCape_STP,waist="Sarissaphoroi belt",legs="Samnuha tights",feet=gear.herculeanBoots_QA}

	sets.engaged.Acc = {ammo="Yamarang",
		head="Mummu bonnet +2",neck="Combatant's torque",ear1="Sherida earring",ear2="Dignitary's earring",
	...
	sets.engaged.TH = {ammo="Yamarang",
		head=gear.herculeanHelm_QA,neck="Anu torque",ear1="Sherida earring",ear2="Brutal Earring",
        body="Adhemar jacket",hands="Plunderer's armlets +1",ring1="Epona's ring",ring2="Petrov Ring",
        back=gear.ToutatisCape_STP,waist="Windbuffet belt +1",legs="Samnuha tights",feet=gear.herculeanBoots_QA}
