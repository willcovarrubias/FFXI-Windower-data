...
function init_gear_sets()
	...
	sets.precast.WS['Savage Blade'] = {head="Lilitu headpiece",neck="Caro necklace",ear1="Moonshade earring",ear2="Ishvara earring",
        ...
        back=gear.CamulusMantle_WSD,waist="Metalsinger Belt",legs=gear.herculeanTrousers_WSD,feet=gear.herculeanBoots_MAB}
	...
	sets.midcast.RA.Acc = set_combine(sets.midcast.RA,
		{head="Meghanada visor +2",neck="Combatant's torque",ring1="Regal ring", ring2="Cacoethic ring +1",
    ...
    sets.idle = {head="Meghanada visor +2",neck="Loricate torque +1",ear1="Etiolation Earring",ear2="Odnowa earring +1",
        ...
        back="Solemnity cape",waist="Flume belt +1",legs="Carmine cuisses +1",feet="Ahosi leggings"}


	sets.idle.DT = {head="Meghanada visor +2",neck="Loricate torque +1",ear1="Etiolation Earring",ear2="Odnowa earring +1",
        body="Meghanada cuirie +2",hands=gear.herculeanGloves_DT,ring1="Vocane Ring",ring2="Defending ring",
        back="Solemnity cape",waist="Flume belt +1",legs="Mummu kecks +2",feet="Ahosi leggings"}
	...
	sets.idle.Refresh = {head="Rawhide mask",neck="Loricate torque +1",ear1="Etiolation Earring",ear2="Odnowa earring +1",
        ...
        back="Solemnity cape",waist="Flume belt +1",legs="Rawhide trousers",feet=gear.herculeanBoots_Refresh}
    -- Defense sets
