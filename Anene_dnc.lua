...
function job_setup()
	...
	include('Anene-Include.lua')
    state.Buff['Sneak Attack'] = buffactive['Sneak Attack'] or false
    state.Buff['Trick Attack'] = buffactive['Trick Attack'] or false

	send_command('alias tp input /equip main "Skinflayer"; input /equip sub "Taming sari";' )
...
-- Misc CTRL	
	...
	send_command('bind ^6 input /ma "Cure VI" <t>')
	send_command('bind ^7 input /ja "Contradance" <me>')
	send_command('bind ^8 input /ma "Regen IV" <t>')
...
-- Debuffs ALT	
	send_command('bind !1 input /ws "Rudra\'s Storm" <t>; input /p --Rudra\'s Storm--')
	send_command('bind !2 input /ws "Evisceration" <t>; input /p --Evisceration--' )
	send_command('bind !3 input /ws "Exenterator" <t>')
	send_command('bind !4 input /ja "warcry" <me>')
	send_command('bind !5 input /ja "provoke" <t>')
...
-- 	Buffs CTRL
	...
	send_command('bind @F1 input /ja "provoke" <t>')
...
function init_gear_sets()
    ...
    sets.precast.WS['Rudra\'s Storm'] = {
        ...
        body="Meghandada cuirie +1",
		hands="regal gloves",
		ring1="Regal Ring",
		ring2="Ilabrat Ring",
        back="Cerb. Mantle +1",
		waist="Fotia Belt",
		legs="Meghandada Chausses +1",
		feet="Meghandada Jambeaus +1"
	}
