...
function job_setup()
	...
	send_command('alias has input /ma "Haste II" radec; wait 15; input /ma "Haste II" gippali; wait 15; input /ma "Haste II" memo; wait 15; input /ma "Haste II" nimla; wait 15; input /ma "Haste II" nickeny; wait 15; input /ma "Haste II" Maximuss')
	send_command('alias flu input /ma "Flurry II" radec; wait 15; input /ma "Flurry II" gippali; wait 15; input /ma "Flurry II" lucried; wait 15; input /ma "Flurry II" memo; wait 15; input /ma "Flurry II" nimla; wait 15; input /ma "Flurry II" nickeny; ')
...
-- 	Buffs CTRL
	...
	send_command('bind @1 input /ma "frazzle III" <t>')
	send_command('bind @2 input /ma "distract III" <t>')
...
-- Debuffs ALT	
	send_command('bind !1 input /ma "refresh II" <t>')
...
function init_gear_sets()
 ...
 sets.midcast.Sleep = {main={ name="Lehbrailg +2", augments={'DMG:+16','Magic crit. hit rate +5','Enmity-4',}},
    sub="Niobid Strap",
    ammo="Pemphredo Tathlum",
    head="Jhakri coronal +1",
    body="Lethargy Sayon",
    hands="Jhalri cuffs +1",
    legs="Jhakri slops +1",
    feet="Jhakri Pigaches +1",
    neck="Incanter's Torque",
    waist="Luminary Sash",
    ...
    sets.idle = {main="earth staff",sub="giuoco grip",ammo="Impatiens",
        ...
        body="Jhakri robe +2",hands="atrophy gloves +1",ring1="dark Ring",ring2="shadow Ring",
        back="umbra cape",waist="Flume Belt",legs="carmine Cuisses +1",feet="atrophy boots +1"}
    ...
    sets.idle.Town = {main="earth staff",sub="giuoco grip",ammo="Impatiens",
        ...
        body="Jhakri robe +2",hands="Atrophy Gloves +1",ring1="dark Ring",ring2="Dark Ring",
        back="Umbra Cape",waist="Flume Belt",legs="carmine Cuisses +1",feet="Hagondes Sabots"}
    
    sets.idle.Weak = {main="earth staff",sub="giuoco grip",ammo="Impatiens",
        head="Vitivation Chapeau",neck="loricate torque +1",ear1="etiolation Earring",ear2="Loquacious Earring",
        body="Jhakri robe +2",hands="Serpentes Cuffs",ring1="dark Ring",ring2="Dark Ring",
