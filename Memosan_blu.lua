  ...
  --  sets.precast.Waltz = {}
   ...
   -- gear.default.weaponskill_neck = "Asperity Necklace"
	...
	sets.precast.WS['Savage Blade'] = {ammo="Mantoptera eye",
        ...
        body=gear.herculeanVest_WSD,hands="Jhakri cuffs +2",ring1="Apate ring",ring2="Shukuyu ring",
    ...
    sets.idle = {ammo="Staunch tathlum",
        ...
        back="Solemnity cape",waist="Flume belt",legs="Carmine cuisses",feet=gear.herculeanBoots_Refresh}
	...
	-- Engaged sets
	sets.engaged.STP = {ammo="Mantoptera eye",
        head=gear.herculeanHelm_TA,neck="Lissome necklace",ear1="Cessance earring",ear2="Brutal earring",	
        body="Adhemar jacket",hands=gear.herculeanGloves_QA,ring1="Petrov ring",ring2="Epona's ring",
        back=gear.rosmertasCape_STP,waist="Sarissaphoroi belt",legs="Samnuha tights",feet=gear.herculeanBoots_QA}

	sets.engaged.Acc = {ammo="Amar Cluster",
        head=gear.herculeanHelm_TA,neck="Combatant's torque",ear1="Telos earring",ear2="Dignitary's earring",	
