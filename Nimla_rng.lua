...
function init_gear_sets()
	...
	sets.precast.JA['Eagle Eye Shot'] = {head="Meghanada visor +2",neck="Iskur gorget",ear1="Enervating earring",ear2="Telos earring",
		body="Orion jerkin +3",hands="Carmine finger gauntlets +1",ring1="Ilabrat ring",ring2="Dingir ring",
		back=gear.belenusCape_WSD,waist="Yemaya belt",legs="Adhemar kecks",feet="Meghanada jambeaux +2"}
    ...
    sets.precast.WS['Coronach'] = {	head="Orion beret +3",neck="Fotia gorget",ear1="Ishvara earring",ear2="Sherida earring",
        body="Meghanada cuirie +2",hands="Meghanada gloves +2",ring1="Ilabrat ring",ring2="Dingir Ring",
        back=gear.belenusCape_WSD,waist="Fotia Belt",legs="Meghanada chausses +2",feet=gear.herculeanBoots_RAWSD} 	
																										
																										
	sets.precast.WS['Detonator'] = {head="Orion beret +3",neck="Fotia gorget",ear1="Moonshade earring",ear2="Ishvara earring",
        body="Orion jerkin +3",hands="Meghanada gloves +2",ring1="Ilabrat ring",ring2="Dingir ring",
        back=gear.belenusCape_WSD,waist="Fotia Belt",legs=gear.herculeanTrousers_RAWSD,feet=gear.herculeanBoots_RAWSD}

	sets.precast.WS['Last Stand'] = {head={ name="Arcadian Beret +1", augments={'Enhances "Recycle" effect',}},
    body="Meg. Cuirie +2",
    hands="Meg. Gloves +2",
    ...
    back=gear.belenusCape_WSD}

	sets.precast.WS['Slug Shot'] = {head="Orion beret +3",neck="Fotia gorget",ear1="Moonshade earring",ear2="Sherida earring",
        body="Orion jerkin +3",hands="Meghanada gloves +2",ring1="Ilabrat ring",ring2="Dingir Ring",
        back="Sylvan chlamys",waist="Fotia Belt",legs="Meghanada chausses +2",feet="Meghanada jambeaux +2"}
	...
	sets.precast.WS['Trueflight'] = {head=gear.herculeanHelm_MAB,neck="Sanctity Necklace",ear1="Friomisi earring",ear2="Moonshade earring",
        body=gear.herculeanVest_MAB,hands="Carmine finger gauntlets +1",ring1="Ilabrat ring",ring2="Dingir Ring",
        back=gear.belenusCape_WSD,waist="Eschan stone",legs=gear.herculeanTrousers_MAB,feet=gear.herculeanBoots_MAB}
	...
	--Midcast Sets--
	sets.midcast.RA = {head={ name="Arcadian Beret +1", augments={'Enhances "Recycle" effect',}},
    body="Meg. Cuirie +2",
    hands="Meg. Gloves +2",
    legs={ name="Adhemar Kecks", augments={'AGI+10','Rng.Acc.+15','Rng.Atk.+15',}},
    feet="Meg. Jam. +2",
    ...
    back=gear.belenusCape_RA}
	
	sets.midcast.RA.Acc = set_combine(sets.midcast.RA,
		{head="Orion beret +3",neck="Combatant's torque",ring1="Hajduk ring +1", ring2="Hajduk ring",
   ...
   -- sets.latent_refresh = {waist="Fucho-no-obi"}
    ...
    sets.engaged.Melee = {head=gear.herculeanHelm_TA,neck="Asperity necklace",ear1="Sherida earring",ear2="Telos earring",	
        body=gear.herculeanVest_TA,hands="Adhemar wristbands",ring1="Petrov ring",ring2="Epona's ring",
