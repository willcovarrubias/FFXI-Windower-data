...
function init_gear_sets()
    ...
    sets.buff['Sneak Attack'] = {
        ...
        body="Pillager's Vest +1",hands="Pillager's Armlets +1",ring1="Petrov Ring",ring2="Epona's Ring",
    ...
    sets.precast.WS = {
        ...
        body="Heculean Vest",hands="Meghanada gloves +2",ring1="Regal Ring",ring2="Ilabrat Ring",
        back="Letalis Mantle",waist="Fotia Belt",legs="Meghanada chausses +2",feet="Meghanada jambeaux +2"}
    ...
    sets.idle = {
      head="Oneiros Helm",neck="Portus collar",ear1="Sherida Earring",ear2="Steelflash Earring",
        body="Herculean Vest",hands="Floral guantlets",ring1="Petrov Ring",ring2="Epona's Ring",
        back="Letalis Mantle",waist="Twilight Belt",legs="Meghanada chausses", feet="Jute Boots +1"}
    ...
    sets.engaged = {ammo="Ginsen",
        head="Mummu bonnet +2",neck="Lissome necklace",ear1="Sherida Earring",ear2="Brutal Earring",
        body="Mummu jacket +2",hands="Floral guantlets",ring1="Petrov Ring",ring2="Epona's Ring",
        back="Letalis Mantle",waist="Windbuffet Belt +1",legs="Samnuha tights", feet=gear.herculeanBoots_TA}
    sets.engaged.Acc = {
        head="Meghanada visor",neck=gear.ElementalGorget,ear1="Sherida Earring",ear2="Steelflash Earring",
        body="Thurandaut tabard +1",hands="Meghanada gloves",ring1="Petrov Ring",ring2="Ifrit Ring",
        back="Letalis Mantle",waist="Wanion Belt",legs="Meghanada chausses", feet=gear.herculeanBoots_TA}
