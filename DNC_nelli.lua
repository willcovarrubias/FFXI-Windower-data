...
function init_gear_sets()
    ...
    body={ name="Herculean Vest", augments={'Accuracy+20 Attack+20','Weapon skill damage +3%','Attack+12',}},
    hands="Meg. Gloves +1",
    legs={ name="Herculean Trousers", augments={'Pet: Mag. Acc.+7','MND+1','Weapon skill damage +10%','Accuracy+13 Attack+13','Mag. Acc.+8 "Mag.Atk.Bns."+8',}},
    feet={ name="Herculean Boots", augments={'Attack+9','Weapon skill damage +5%','AGI+6','Accuracy+8',}},
    neck="Fotia Gorget",
    waist="Fotia Belt",
