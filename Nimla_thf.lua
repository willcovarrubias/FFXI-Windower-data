...
function init_gear_sets()
    ...
    body={ name="Herculean Vest", augments={'Pet: Mag. Acc.+19','Weapon skill damage +4%','STR+6 DEX+6','Accuracy+8 Attack+8','Mag. Acc.+8 "Mag.Atk.Bns."+8',}},
    hands="Meg. Gloves +1",
    ...
    left_ear="Ishvara Earring",
    right_ear="Sherida Earring",
    left_ring={ name="Dark Ring", augments={'Phys. dmg. taken -4%','Breath dmg. taken -3%','Magic dmg. taken -4%',}},
    ...
    sets.idle = {ammo="Thew Bomblet",
        ...
        body="Pillager's Vest +1",hands="Pillager's Armlets +1",ring1="dark Ring",ring2="defending Ring",
