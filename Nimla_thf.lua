...
function job_setup()
	...
	send_command('alias cpring input /equip ring1 "Capacity Ring"; wait 6; input /item "Capacity Ring" <me>')
    send_command('alias trizek input /equip ring1 "Trizek Ring"; wait 6; input /item "Trizek Ring" <me>')
...
function user_setup()
	...
	state.OffenseMode:options('TH', 'Acc', 'Att', 'DW', 'Tank')
...
function init_gear_sets()
	...
	sets.precast.WS['Rudra\'s Storm'] = {
        ...
        body=gear.herculeanVest_WSD,hands="Meghanada gloves +2",ring1="Regal ring",ring2="Ilabrat Ring",
        back=gear.ToutatisCape_WSD,waist="Fotia belt",legs=gear.herculeanTrousers_WSD,feet=gear.herculeanBoots_WSD}
	...
	sets.precast.WS['Aeolian Edge'] = {
        ...
        body=gear.herculeanVest_MAB,hands="Leyline gloves",ring1="Dingir ring",ring2="Regal Ring",
